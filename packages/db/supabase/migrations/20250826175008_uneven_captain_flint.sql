...
ALTER TABLE "listings" ADD COLUMN "about_role" text NOT NULL DEFAULT '';--> statement-breakpoint
ALTER TABLE "listings" ADD COLUMN "responsibilities" text NOT NULL DEFAULT '';--> statement-breakpoint
ALTER TABLE "listings" ADD COLUMN "requirements" text NOT NULL DEFAULT '';--> statement-breakpoint
...
ALTER TABLE "listings" ADD COLUMN "employment_type" "employment_type" NOT NULL DEFAULT 'Full-time';--> statement-breakpoint
